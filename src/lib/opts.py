...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='coco',
                             help='coco | kitti | coco_hp | pascal | deepfashion2')
    ...
    #Added for neptune
    self.parser.add_argument('-n', '--neptune', dest='neptune', action='store_true',
                        help='run with neptune')

    self.parser.add_argument('--neptune-path', default='neptune.txt', type=str, metavar='PATH',
                  help='Neptune API keys (default: neptune.txt)')

    #Added for generating gallery
    self.parser.add_argument('--consumer_gallery', action='store_true', help='Perform inference on consumer gallery')
    self.parser.add_argument('--shop_gallery', action='store_true', help='Perform inference on shop gallery')
