# Better Conversion script from https://github.com/switchablenorms/DeepFashion2/issues/13
...
num_images = len(os.listdir('./data/deepfashion2/train/annos/'))
...
for num in range(1, num_images + 1):
    json_name = './data/deepfashion2/train/annos/' + str(num).zfill(6) + '.json'
...
json_name = './data/deepfashion2/annotations/deepfashion2_train.json'
